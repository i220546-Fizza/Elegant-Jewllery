      ...
      <div className="container-luxe grid grid-cols-1 items-center gap-10 py-16 sm:py-24 lg:grid-cols-2 lg:py-28">
        ...
        >
          ...
          >
            ...
            >
              <img src="/uploads/products/category-earrings.jpg" alt="Chandelier earrings" className="h-full w-full rounded-xl object-cover" />
            </motion.div>
            ...
            >
              <img src="/uploads/products/category-necklaces.jpg" alt="Layered necklace" className="h-full w-full rounded-xl object-cover" />
            </motion.div>
            ...
            >
              <img src="/uploads/products/category-rings.jpg" alt="Halo rings" className="h-full w-full rounded-xl object-cover" />
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
